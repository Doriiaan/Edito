...
void test_insert_eLine_normal(void)
{
	eLine *eline = create_eLine("Hello world!", 32, 0, NULL, NULL);
	int result = insert_eLine(eline, "the big ", 32, 6);
...
void test_insert_eLine_limit1(void)
{
	eLine *eline = create_eLine("Hello world!", 32, 0, NULL, NULL);
	int result = insert_eLine(eline, "$$$$", 32, 0);
...
void test_insert_eLine_limit2(void)
{
	eLine *eline = create_eLine("Hello world!", 32, 0, NULL, NULL);
	int result = insert_eLine(eline, "$$$", 32, 0);
...
void test_insert_eLine_limit3(void)
{
	eLine *eline = create_eLine("Hello world!", 32, 0, NULL, NULL);
	int result = insert_eLine(eline, "$$$$", 32, 12);
...
void test_insert_eLine_bad_pos(void)
{
	
	eLine *eline = create_eLine("Hello world!", 32, 0, NULL, NULL);
	int result = insert_eLine(eline, "BAD GUY", 32, 1000);
...
void add_tests_eLine(CU_pSuite pSuite)
{
	...
	CU_add_test(pSuite, "insert_eLine() with normal insertion", test_insert_eLine_normal);
	CU_add_test(pSuite, "insert_eLine() with bad position insertion", test_insert_eLine_bad_pos);
	CU_add_test(pSuite, "insert_eLine() with limit test1", test_insert_eLine_limit1);
	CU_add_test(pSuite, "insert_eLine() with limit test2", test_insert_eLine_limit2);
	CU_add_test(pSuite, "insert_eLine() with limit test3", test_insert_eLine_limit3);
}
